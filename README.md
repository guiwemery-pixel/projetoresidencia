...
| **Importar planilha** | Em Estudos ou Perfil: envie .xlsx ou .csv (uma linha por estudo, ou uma linha por assunto com revisões lado a lado). Colunas reconhecidas sozinhas e ajustáveis, prévia, reimportação sem duplicar e revisões recalculadas pelo algoritmo. O arquivo é lido no navegador; só os estudos vão para a conta de quem importa. |
